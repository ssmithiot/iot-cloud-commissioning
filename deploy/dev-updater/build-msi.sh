...
MSI="$OUT_DIR/$APP-0.2.0-dev.2-x64.msi"
...
printf '%s\n' "IOT Edge Development Updater 0.2.0-dev.2" "MSI ProductVersion: $VERSION" "Source commit: $(git -C "$REPO" rev-parse HEAD)" > "$STAGE/VERSION.txt"
