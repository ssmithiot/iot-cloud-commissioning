...
def gateway_workspace_html(gateway_id: str) -> str:
  ...
  <main class="gateway-nav-content">
    ...
    <section class="bms-shell" aria-labelledby="bms-graphic-title">
      ...
      <div class="bms-grid">
        <article class="bms-tile third"><span class="bms-label">Equipment Info</span><div class="bms-value">RTU-1</div><div class="bms-sub">Rooftop Unit (Packaged)<br>Retail Floor — Zone 2<br>Carrier 48TC-016 · Auto<br><span class="bms-status">Filter OK — 62 days</span></div></article>
        <article class="bms-tile third"><span class="bms-label">Weather / Outdoor Air</span><div class="bms-value">84°F</div><div class="bms-sub">Partly Cloudy — Chicago, IL<br>OA Humidity 57% · Wind 9 mph SW<br>Dew point 64°F · High / Low 89° / 71°</div></article>
        <article class="bms-tile third"><span class="bms-label">Reversing Valve &amp; Alarms</span><div class="bms-status">● Energized — Cooling Mode</div><div class="bms-sub">Active alarms <span class="bms-status">0 Active</span><br>Comm status <span class="bms-status">Online</span><br>Last alarm: Low SAT (cleared)</div></article>
        <article class="bms-tile third"><span class="bms-label">Space Temp</span><div class="bms-value">72.4°F</div><div class="bms-sub">Setpoint 72.0°F · +0.4° above</div></article>
        <article class="bms-tile third"><span class="bms-label">Supply Air Temp</span><div class="bms-value">57.8°F</div><div class="bms-sub">24h avg 58.6°F · −0.8°</div></article>
        <article class="bms-tile third"><span class="bms-label">Return Air Temp</span><div class="bms-value">74.1°F</div><div class="bms-sub">24h avg 73.7°F · +0.4°</div></article>
        <article class="bms-tile status"><span class="bms-label">Supply Fan</span><div class="bms-status">● Running</div><div class="bms-sub">Speed 68% · VFD</div></article><article class="bms-tile status"><span class="bms-label">Cool Stage 1</span><div class="bms-status">● Running</div><div class="bms-sub">Compressor A · 3.2A</div></article><article class="bms-tile status"><span class="bms-label">Cool Stage 2</span><div class="bms-sub">● Off<br>Compressor B · Standby</div></article><article class="bms-tile status"><span class="bms-label">Heat Stage 1</span><div class="bms-sub">● Off<br>Gas valve · Locked out</div></article><article class="bms-tile status"><span class="bms-label">Heat Stage 2</span><div class="bms-sub">● Off<br>Gas valve · Locked out</div></article><article class="bms-tile status"><span class="bms-label">Filter / Damper</span><div class="bms-status">● Clean</div><div class="bms-sub">OA Damper 22% open</div></article>
        <article class="bms-tile setpoint"><span class="bms-label">Active Effective Setpoints</span><div class="bms-value">Cool 73.0°F / Heat 70.0°F</div>
          <div class="bms-setpoints"><div class="bms-setpoint"><span class="bms-label">Occupied Setpoints · Active</span><strong>Cool 73.0°F <button disabled>−</button><button disabled>+</button><br>Heat 70.0°F <button disabled>−</button><button disabled>+</button></strong></div><div class="bms-setpoint"><span class="bms-label">Unoccupied Setpoints · Standby</span><strong>Cool 85.0°F <button disabled>−</button><button disabled>+</button><br>Heat 60.0°F <button disabled>−</button><button disabled>+</button></strong></div></div><div class="bms-sub">Controls are read-only in Phase 1.</div></article>
      </div>
