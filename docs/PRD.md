...
- The current browser shell loads proxied HTML into an iframe. Complex gateway UI assets, cookies, and form workflows may still need a short-lived signed tunnel session URL in a later polish slice.
