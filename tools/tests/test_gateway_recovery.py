...
def test_restore_requires_checked_code_archive_and_not_full_folder_extract() -> None:
    ...
    assert "cp -a app.py edge_program_engine.py edge_trend_store.py timed_override_store.py router_config.py README.md requirements.txt templates static /home/swadmin/edge-bacnet-ui-v2/" in commands
